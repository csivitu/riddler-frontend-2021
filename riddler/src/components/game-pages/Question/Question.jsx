...
import { AContainer, AnswerBox, QContainer, QuestionBox, QuestionContent, TrackBox, Trackname, OurButton, ButtonContainer, Hint, QBtnContainer } from './style'
...
function Question() {
    ...
    useEffect(() => {
        setQues("Did you hear about the puppet? No, not miss piggy, but you’re pulling the right strings. Close, but you have much lesser than 900 years to find the answer. This Is The Way to go.Almost there, but that’s just what everyone calls him. Maybe you should ask for his real name?");
        ...
        <QContainer>
            ...
            <QuestionBox>
                ...
                <QBtnContainer>
                    ...
                    <IconButton><img src={mapIcon} alt="" /></IconButton>
                </QBtnContainer>
            </QuestionBox>
            <AContainer>
